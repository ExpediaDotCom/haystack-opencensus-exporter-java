[![Build Status](https://travis-ci.org/ExpediaDotCom/haystack-opencensus-exporter-java.svg?branch=master)](https://travis-ci.org/ExpediaDotCom/haystack-opencensus-exporter-java)
